...
class ResidualDecoder(nn.Module):
    def __init__(self, block_sizes=[2, 2, 2, 2, 2]):
        ...
        self.decoder_blocks = nn.ModuleList([
            self._make_layer(512, 256, block_sizes[0]),
            self._make_layer(256+256, 128, block_sizes[1]),
            self._make_layer(128+128, 64, block_sizes[2]),
            self._make_layer(64+64, 64, block_sizes[3]),
            self._make_layer(64, 32, block_sizes[4])
        ])
